                    ...
                    <div class="tab-content">
                      <!-- PROFILE -->
                        <div id="navs-pills-top-profile" class="tab-pane fade active show" role="tabpanel">
                          ...
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="turn">Turno</label>
                            <div class="col-sm-10">
                              <div class="input-group input-group-merge">
                                <span id="turn2" class="input-group-text"><i class="bx bx-time"></i></span>
                                <input type="text" class="form-control" name="turn" id="turn" placeholder="Turno" aria-label="Turno" >
                              </div>
                            </div>
                          </div>
